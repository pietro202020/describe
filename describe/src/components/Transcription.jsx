...
import AccTranscription from './AccTranscription'
import AccTranslation from './AccTranslation'
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 max-w-prose w-full mx-auto'>
            ...
            <div className='my-8 flex flex-col-reverse max-w-prose w-full mx-auto gap-4'>
                ...
                {tab === 'transcription' ? (
                    <AccTranscription {...props} textElement={textElement} />
                ) : (
                    <AccTranslation {...props} toLanguage={toLanguage} translating={translating} textElement={textElement} setTranslating={setTranslating} setTranslation={setTranslation} setToLanguage={setToLanguage} generateTranslation={generateTranslation} />
                )}
            </div>
