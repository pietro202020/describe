...
export default function Transcribe(props) {
    ...
    return (
        <div className='flex flex-1 items-center flex-col justify-center gap-10 md:gap-14 pb-24 p-12 text-center'>
            <div className='flex flex-col gap-2 sm:gap-4'>
                <h1 className='font-semibold text-4xl sm:text-5xl md:text-6xl'><span className='text-blue-400 bold'>DeScribing</span></h1>
